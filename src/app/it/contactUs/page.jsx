        ...
        <form onSubmit={handleSubmitForm} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows="5"
              className="w-full p-3 border border-[#5C4033]  rounded-md"
              placeholder="Facci sapere in che modo possiamo aiutarti oppure lascia il tuo feedback qui (Se vuoi lasciare una recensione anonima, inserisci come nome ed email: anonymous@email.com)"
              required
            />
          </div>
          <button
        ...
        <div className="space-y-4">
          <div className="transition-colors">
            ...
            <p className="text-gray-500">
              Puoi prenotare una stanza direttamente dal nostro sito web o
          ...
          <div className="transition-colors">
            ...
            <p className="text-gray-500">
              Il check-in è disponibile dalle 14:00, mentre il check-out deve
              essere effettuato entro le 11:00. Se hai bisogno di flessibilità,
              faccelo sapere.
            </p>
          </div>
          <div className="transition-colors">
            ...
            <p className="text-gray-500">
              ...
              opzioni, incluse alternative vegetariane e vegane.
            </p>
          </div>
        </div>
      </section>
