      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/images/centro-studi-bahai-camera-ospiti-meeting-aziendali.webp"
              alt="Double room"
              width={600}
              height={400}
            ...
            />
            <Image
              src="/images/centro-studi-bahai-camera-ospiti-scrivania-business.webp"
              alt="Spazio studio luminoso in camera per ospiti al Centro Studi Bahá’í, ideale per meeting aziendali"
              width={600}
              height={400}
              className="rounded-xl object-cover w-full h-full"
            />
            <Image
              src="/images/centro-studi-bahai-camera-familiare-business.webp"
              alt="Camera familiare con letto matrimoniale e spazio di lavoro al Centro Studi Bahá’í per viaggi d’affari"
              width={600}
              height={400}
