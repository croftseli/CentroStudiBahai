        ...
        <div className="rounded-2xl border border-black/10 bg-white/70 shadow-[0_10px_28px_rgba(0,0,0,0.06)] overflow-hidden h-full">
          <div className="p-8">
            ...
            <div className="mt-6 space-y-6 text-[17px] leading-relaxed text-gray-800">
              <p>
                Godetevi comfort e tranquillità nelle nostre camere accoglienti e pulite, complete
                di bagno privato, WiFi gratuito, TV e una splendida vista
                sulla valle o sul versante. Disponiamo di 35 camere, tra singole,
                doppie, triple, quadruple e una quintuple, alcune delle quali offrono
                la possibilità di un letto aggiuntivo o di una culla per bambini fino a 3 anni.
                Il relax vi aspetta.
              </p>
              ...
              <p>
                Contattateci per prenotare il vostro soggiorno o per qualsiasi richiesta. Siamo qui per
                assistervi per le vostre esigenze di alloggio.
              </p>
            </div>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="mt-6 divide-y divide-black/10">
              <div className="py-5 flex items-start justify-between gap-6">
                <div className="text-gray-800 font-medium">Prenotazioni</div>
                <div className="text-gray-600 text-right">
                  Usa il modulo oppure invia un'email direttamente per le prenotazioni.
                </div>
              </div>
              ...
              <div className="py-5 flex items-start justify-between gap-6">
                ...
                <div className="text-gray-600 text-right">
                  Indica le date, il numero di ospiti e la tipologia di camera.
                </div>
              </div>

              <div className="py-5 flex items-start justify-between gap-6">
                <div className="text-gray-800 font-medium">Tempi di Risposta</div>
                <div className="text-gray-600 text-right">
          ...
          <div className="space-y-7">
            <div className="border-b border-black/10 pb-7">
              ...
              <p className="text-gray-600 mt-2 leading-relaxed">
                Puoi prenotare una camera direttamente tramite il nostro sito web oppure
            ...
            <div className="border-b border-black/10 pb-7">
              ...
              <p className="text-gray-600 mt-2 leading-relaxed">
                Il check-in è a partire dalle 14:00 e il check-out entro le 11:00.
                Se hai bisogno di flessibilità, faccelo sapere.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2 leading-relaxed">
                Sì, la colazione è inclusa nel soggiorno. Offriamo una varietà di
                opzioni, incluse scelte vegetariane e vegane.
              </p>
            </div>
          </div>
        </SectionShell>
...
>
  <div className="p-10">
    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
      <div>
        <h2 className="text-3xl font-semibold text-dark-brown">Contatti</h2>
        <p className="text-gray-600 mt-2 leading-relaxed">
...
>
  <div className="p-10">
    ...
    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
      <div>
        <h2 className="text-3xl font-semibold text-dark-brown">Come Raggiungerci</h2>
        <p className="text-gray-600 mt-2 leading-relaxed">
      ...
      <div className="lg:col-span-5 flex flex-col min-h-[620px]">
        ...
        <div className="rounded-2xl border border-black/10 bg-white/70 px-6 py-6 shadow-[0_10px_26px_rgba(0,0,0,0.06)]">
          ...
          <p className="mt-3 text-gray-600 leading-relaxed">
            Si prega di notare che la nostra posizione su Google Maps potrebbe non essere accurata. Per
            evitare qualsiasi confusione, consigliamo di utilizzare le coordinate qui sotto per
          ...
          <p className="mt-5 text-sm text-gray-600">
            Parcheggio gratuito disponibile per gli ospiti che arrivano in auto (dall'autostrada A1
            prendere l'uscita Anagni-Fiuggi).
          </p>
        </div>
        ...
        <div className="mt-8 space-y-4 flex-1">
          <div className="rounded-2xl border border-black/10 bg-white/60 px-6 py-5">
            ...
            <p className="mt-2 text-gray-700 leading-relaxed">
              Per richiedere un trasferimento taxi dagli aeroporti di Fiumicino o
              Ciampino, o un pick-up da Roma o Fiuggi, contattaci a:
            </p>
            <a
              href="mailto:centrostudibahai@gmail.com"
          ...
          <div className="rounded-2xl border border-black/10 bg-white/60 px-6 py-5">
            <p className="text-sm font-semibold text-dark-brown">In Autobus</p>
            <p className="mt-2 text-gray-700 leading-relaxed">
          ...
          <div className="rounded-2xl border border-black/10 bg-white/60 px-6 py-5">
            <p className="text-sm font-semibold text-dark-brown">In Treno</p>
            <p className="mt-2 text-gray-700 leading-relaxed">Per arrivare in treno, consulta:</p>
