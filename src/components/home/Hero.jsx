      ...
      <div className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 z-40">
          <div className="max-w-3xl">
            ...
            <motion.a
              href={language === "it" ? "/it/contactUs" : "/contactUs"}
              variants={textVariants}
              initial="hidden"
              animate="visible"
              custom={0.75}
      ...
      <div className="bg-white px-6 py-12 space-y-20">
        ...
        >
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {/* Card 1 */}
            <Link
              href={language === "it" ? "/it/services" : "/services"}
              className="block h-full"
            >
              <motion.div
                variants={fancySectionVariants}
                custom={0} // delay
                className="flex flex-col h-full rounded-xl shadow-lg p-6 bg-gray-50 overflow-hidden rounded-md"
              >
        ...
        >
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {/* Card 1 */}
            <Link
              href={language === "it" ? "/it/surroundings" : "/surroundings"}
              className="block h-full"
            >
              <motion.div
                variants={fancySectionVariants}
