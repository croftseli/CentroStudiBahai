...
const content = {
  en: {
    ...
    missionText: [
      ...
      "Equipped with 35 rooms; single, double, triple, and quadruple; a conference room seating up to 140, featuring audio and video systems; and a restaurant hall that seats up to 100 people.",
